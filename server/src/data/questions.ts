 ...
 *   - Trees (Diameter of Binary Tree — Python)
 */
...
class Solution {
  ...
  {
    id: "product-of-array-except-self-python",
...
class Solution {
  ...
  {
    id: "lowest-common-ancestor-python",
    title: "Lowest Common Ancestor of a Binary Tree (Python)",
    description:
      "Given a binary tree, find the lowest common ancestor (LCA) of two given nodes in the tree.\n\nAccording to the definition of LCA on Wikipedia: \"The lowest common ancestor is defined between two nodes `p` and `q` as the lowest node in `T` that has both `p` and `q` as descendants (where we allow **a node to be a descendant of itself**).\"",
    examples: [
      "Input: root = [3,5,1,6,2,0,8,null,null,7,4], p = 5, q = 1\nOutput: 3\nExplanation: The LCA of nodes 5 and 1 is 3.",
...
class Solution:
  ...
  {
    id: "longest-consecutive-sequence-python",
    title: "Longest Consecutive Sequence (Python)",
    description:
      "Given an unsorted array of integers `nums`, return the length of the longest consecutive elements sequence.\n\nYou must write an algorithm that runs in `O(n)` time.\n\nConstraints:\n- `0 <= nums.length <= 10^5`\n- `-10^9 <= nums[i] <= 10^9`",
    examples: [
      "Input: nums = [100,4,200,1,3,2]\nOutput: 4\nExplanation: The longest consecutive elements sequence is [1, 2, 3, 4]. Therefore its length is 4.",
...
class Solution {
  ...
  {
    id: "diameter-of-binary-tree-python",
    title: "Diameter of Binary Tree (Python)",
    description:
      "Given the root of a binary tree, return the length of the diameter of the tree.\n\nThe diameter of a binary tree is the length of the longest path between any two nodes in a tree. This path may or may not pass through the root.\n\nThe length of a path between two nodes is represented by the number of edges between them.\n\nConstraints:\n- The number of nodes in the tree is in the range [1, 10^4].\n- -100 <= Node.val <= 100",
    examples: [
      "Input: root = [1,2,3,4,5]\nOutput: 3\nExplanation: 3 is the length of the path [4,2,1,3] or [5,2,1,3].",
